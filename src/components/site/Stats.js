...
const PILLARS = [
  { icon: GraduationCap, anim: "st-cap", title: "For Classes I–X", text: "Age-appropriate assessment, Bal Vatika to Class 10.", bg: "linear-gradient(135deg,#ec4899 0%,#fb923c 100%)", tint: "#fdf2f8", line: "#ec4899", glow: "rgba(236,72,153,0.45)" },
