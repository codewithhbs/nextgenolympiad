...
import { BookOpen, Plus, Minus, FileText, RefreshCw, Search, Download, GitBranch, Puzzle, Cpu, Binary } from "lucide-react";
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-10 pt-12 md:px-6 md:pt-16">
          ...
          <p className="mt-3 max-w-3xl text-[15px] leading-relaxed text-slate">
            Class-wise Computational Thinking syllabus covering logic, patterns, algorithms and problem-solving — the literacy of the next decade.
          </p>
        </div>
      </section>
        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-14 pt-14 md:px-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-display text-2xl font-extrabold tracking-tight text-ink">
              Skills Assessed with Computational Thinking Olympiad
            </h2>
          </div>
